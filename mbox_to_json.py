...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input", default="Sent-001.mbox", help="Input mbox file (default: mail.mbox)")
    parser.add_argument("-o", "--output", default="Sent-001.mbox.json", help="Output JSON file (default: mail_output.json)")
